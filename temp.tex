...
\runningheadrule
\runningfootrule
\runningheader{CS 113 Discrete Mathematics}{HW I: Sets}{Spring 2021}
...
\title{Homework I: Sets\\ CS 113 Discrete Mathematics\\ Habib University -- Spring 2021}
\author{xy01234}  % replace with your ID, e.g. oy02945
\date{}
...
\question
  ...
  \part[5] Imagine that the the operation above is extended to include an additional set that contains all the time slots when a course can be scheduled. Desribe the set obtained as an outcome of the operation.
    \begin{solution}
      % Enter your solution here.
    \end{solution}
...
\question
  ...
  \part[10] For three sets $A, B,$ and $C$, the symmetric difference is defined
    \[
      A\oplus B\oplus C = (A\oplus B)\oplus C,
    \]
    i.e. the two set definition is applice twice. Draw the Venn diagram of this set and express it as in part (a).
    \begin{solution}
      % Enter your solution here.
    \end{solution}
